...
export class Todo1622205817548 implements MigrationInterface {
  name = 'Todo1622205817548';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "todo" ("id" SERIAL NOT NULL, "header" character varying NOT NULL, "body" text NOT NULL, "userId" integer NOT NULL, "status" "todo_status_enum" NOT NULL DEFAULT 'in progress', CONSTRAINT "PK_d429b7114371f6a35c5cb4776a7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
