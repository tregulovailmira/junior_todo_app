...
export class Todo1622619770191 implements MigrationInterface {
  name = 'Todo1622619770191';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "todo_status_enum" AS ENUM('done', 'in progress')`,
    );
    await queryRunner.query(
      `CREATE TABLE "todo" ("id" SERIAL NOT NULL, "header" character varying NOT NULL, "body" text NOT NULL, "userId" integer NOT NULL, "status" "todo_status_enum" NOT NULL DEFAULT 'in progress', "deadline" date NOT NULL, CONSTRAINT "PK_d429b7114371f6a35c5cb4776a7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "attachment" ADD CONSTRAINT "FK_8802f8b09f852588593ed105493" FOREIGN KEY ("todoId") REFERENCES "todo"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
